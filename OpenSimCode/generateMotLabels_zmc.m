function labels = generateMotLabels(nFP)
...
for i=0:nFP-1
    ...
    labels{1+i*6} = [num2str(i+1),'_ground_force_vx'];
    labels{2+i*6} = [num2str(i+1),'_ground_force_vy'];
    labels{3+i*6} = [num2str(i+1),'_ground_force_vz'];
    labels{4+i*6} = [num2str(i+1),'_ground_force_px'];
    labels{5+i*6} = [num2str(i+1),'_ground_force_py'];
    labels{6+i*6} = [num2str(i+1),'_ground_force_pz'];
end

for i=1:nFP
    n = length(labels);
     labels{n+1} = [num2str(i),'_ground_torque_x'];
     labels{n+2} = [num2str(i),'_ground_torque_y'];
     labels{n+3} = [num2str(i),'_ground_torque_z'];
end
% 
% switch nFP
%     
